...
class TagGroupTranslation(Base):
    __tablename__ = 'tag_group_translations'
    ...
    __table_args__ = (
        UniqueConstraint('tag_group_definition_id', 'language', name='uq_tag_group_translations_group_language'),
        Index('idx_tag_group_translations_group_id', 'tag_group_definition_id'),
        Index('idx_tag_group_translations_language', 'language'),
    )
