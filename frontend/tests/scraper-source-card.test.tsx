...
import { formatFrequency, formatCountdown } from '../components/scraper-source-card'
...
describe('SourceCard', () => {
  ...
  it('renders source name and type', async () => {
    const { SourceCard } = await import('../components/scraper-source-card')
  ...
  it('ActivityGraph renders bars for non-zero activity data', async () => {
    const { ActivityGraph } = await import('../components/scraper-source-card')
