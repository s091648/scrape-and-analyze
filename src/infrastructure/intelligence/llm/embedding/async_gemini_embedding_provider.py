...
class AsyncGeminiEmbeddingProvider(AsyncBaseEmbeddingProvider):
    """024-async-pipeline-refactor: async sibling of GeminiEmbeddingProvider
    (untouched — still used by the shared, out-of-scope build_llm_service()).
    Same genai.Client, called through its `.aio` namespace."""
