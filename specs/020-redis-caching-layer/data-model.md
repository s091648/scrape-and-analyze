...
|---|---|---|
| `articles` | `GET /articles` | `PipelineCompletedEvent` handler; `topics.py` write endpoints (topic scoping affects article filtering); `tag_service.py` write functions (tag renames/merges affect filter values) |
