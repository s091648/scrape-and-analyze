    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Tasks', link: '/specs/010-grafana-tracing-charts/tasks' },
          { text: 'Research', link: '/specs/010-grafana-tracing-charts/research' },
          { text: 'Quick Start', link: '/specs/010-grafana-tracing-charts/quickstart' },
