...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      {
        text: '020 · Redis Caching Layer',
        collapsed: true,
        items: [
          { text: 'Spec', link: '/specs/020-redis-caching-layer/spec' },
          { text: 'Plan', link: '/specs/020-redis-caching-layer/plan' },
          { text: 'Data Model', link: '/specs/020-redis-caching-layer/data-model' },
          { text: 'Tasks', link: '/specs/020-redis-caching-layer/tasks' },
          { text: 'Research', link: '/specs/020-redis-caching-layer/research' },
          { text: 'Quick Start', link: '/specs/020-redis-caching-layer/quickstart' },
          { text: 'Requirements', link: '/specs/020-redis-caching-layer/checklists/requirements' },
          { text: 'Contract: Cache Gateway', link: '/specs/020-redis-caching-layer/contracts/cache-gateway' },
          { text: 'Contract: Cli Notification Events', link: '/specs/020-redis-caching-layer/contracts/cli-notification-events' },
        ],
      },
      {
        text: '021 · Ssr Public Pages',
        collapsed: true,
        items: [
          { text: 'Spec', link: '/specs/021-ssr-public-pages/spec' },
          { text: 'Plan', link: '/specs/021-ssr-public-pages/plan' },
          { text: 'Data Model', link: '/specs/021-ssr-public-pages/data-model' },
          { text: 'Tasks', link: '/specs/021-ssr-public-pages/tasks' },
          { text: 'Research', link: '/specs/021-ssr-public-pages/research' },
          { text: 'Quick Start', link: '/specs/021-ssr-public-pages/quickstart' },
          { text: 'Requirements', link: '/specs/021-ssr-public-pages/checklists/requirements' },
          { text: 'Contract: Ssr Data Fetch', link: '/specs/021-ssr-public-pages/contracts/ssr-data-fetch' },
          { text: 'Contract: Ssr Preference Cookies', link: '/specs/021-ssr-public-pages/contracts/ssr-preference-cookies' },
        ],
      },
      {
        text: '022 · Lighthouse Performance Check',
        collapsed: true,
        items: [
          { text: 'Spec', link: '/specs/022-lighthouse-performance-check/spec' },
          { text: 'Plan', link: '/specs/022-lighthouse-performance-check/plan' },
          { text: 'Data Model', link: '/specs/022-lighthouse-performance-check/data-model' },
          { text: 'Tasks', link: '/specs/022-lighthouse-performance-check/tasks' },
          { text: 'Research', link: '/specs/022-lighthouse-performance-check/research' },
          { text: 'Quick Start', link: '/specs/022-lighthouse-performance-check/quickstart' },
          { text: 'Requirements', link: '/specs/022-lighthouse-performance-check/checklists/requirements' },
          { text: 'Contract: Cli Interface', link: '/specs/022-lighthouse-performance-check/contracts/cli-interface' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Research', link: '/specs/023-article-search/research' },
          { text: 'Quick Start', link: '/specs/023-article-search/quickstart' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Research', link: '/specs/024-async-pipeline-refactor/research' },
          { text: 'Quick Start', link: '/specs/024-async-pipeline-refactor/quickstart' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Research', link: '/specs/025-iac-provisioning/research' },
