    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Exception Handling Guideline', link: '/guide/architecture/exception-handling' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Router Audit', link: '/specs/017-exception-handling-guideline/router-audit' },
